...
/**
 * 视觉主题令牌接口，见详细设计 §3.3.1（API-FT002-01）。
 *
 * <p>接口为只读、无参数：**不接收主题标识参数**——生效主题由服务端配置
 * {@code platform.theme.active} 决定，客户端不得指定，防止绕过运维回退开关（§3.2）。
 *
...
public class ThemeController {
     ...
     * （AC-ft-FT-002-03）。令牌包缺失或非法时 {@link ThemeService#getTokenSet()} 抛 M01-E007
